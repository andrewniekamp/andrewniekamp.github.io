  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 p-3">
        <a target="_blank" href="https://www.linkedin.com/in/andrewniekamp/">
          <svg
            role="img"
            viewBox="0 0 24 24"
        ...
        <a target="_blank" href="https://github.com/andrewniekamp">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        {/* // TODO: <a target="_blank" href="mailto:contact@example.com"> */}
        <a href="#">
